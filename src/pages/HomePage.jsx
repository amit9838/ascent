...
export default function HomePage({ done, onToggle }) {
  ...
  return (
    <div>
      ...
      {qotd && (
        <section className="mb-6 rounded-xl border border-amber-200 bg-amber-50 p-5 shadow-sm dark:border-amber-900 dark:bg-amber-950/50">
      ...
      <MonthlyPlanCard data={data} done={done} />
